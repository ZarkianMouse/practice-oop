...
// Rooms with description and travel
Room RM[RL] {
  //Room(Location, Description, Directions/Travel)
  Room(Unassigned, " ",
  ...
  Room(Tree, "*I'm in the top of a tall cypress tree.",
   {Unassigned,Unassigned,Unassigned,Unassigned,Unassigned,Swamp}),
  Room(Stump,"large hollow damp stump in the swamp.",
   {Unassigned,Unassigned,Unassigned,Unassigned,Swamp,Root}),
  Room(Root,"root chamber under the stump.",
   {Unassigned,Unassigned,Unassigned,Unassigned,Stump,Hole}),
  Room(Hole,"semi-dark hole by the root chamber.",
  ...
  Room(EightRoom,"large 8-sided room.",
  ...
  Room(RoyalChamber,"royal chamber.",
  ...
  Room(Bog,"quick-sand bog.",
   {Unassigned,Unassigned,Unassigned,Unassigned,Unassigned,Unassigned}),
  Room(PC,"memory RAM of an IBM-PC.  I took a wrong turn!",
  ...
  Room(Empty4, " ",
   {Unassigned,Unassigned,Unassigned,Unassigned,Unassigned,Unassigned}),
  Room(MistRoom,"large misty room with strange letters over the exits.",
