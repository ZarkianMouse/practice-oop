...
// of this class is the *cross product* of the
// set of values of Rank and Suit.
struct Card
{
  Rank rank;
  Suit suit;
...
// can *substitute* equal values as inputs to (certain)
// functions and expect equal results.
...
// Be careful, these have indeterminate value.
Card cards[52];
...
// Value semantics.
//
// Any type (class) that can be copied (and moved)
// is typically said to have "value semantics".
//
// Value semantic types are also said to be Regular
// types.
